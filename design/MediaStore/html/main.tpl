             ...
             <div class="newsmain">
              ...
              <div class="main_adv_banners clearfix">
                <div id="bxdynamic_page_home_adv">
                    <div class="main_adv_banners-banner">
                        <a href="./dostavka"><img alt="Баннер 3" title="Баннер 3" src="design/{$settings->theme|escape}/images/b1.png" width="315" height="153" border="0"></a>
                    </div>
                    <div class="main_adv_banners-banner">
                        <a href="./rasprodazha"><img alt="Баннер 3" title="Баннер 3" src="design/{$settings->theme|escape}/images/b2.png" width="315" height="153" border="0"></a>
                    </div>
                    <div class="main_adv_banners-banner">
                        <a href="./garantiya-samoj-nizkoj-tseny"><img alt="Баннер 3" title="Баннер 3" src="design/{$settings->theme|escape}/images/b3.png" width="315" height="153" border="0"></a>
                    </div>
                </div>
              </div>
              <!-- /banners -->
              ...
              <div class="main_bot_banners">
                <div class="main_bot_banners-banner">
                  <a href="./aktsii" title="Баннер 1"><img src="design/{$settings->theme|escape}/images/banner1.png" alt=""  title="" /></a>
                </div>
                <div class="main_bot_banners-banner">
                  <a href="./dostavka" title="Баннер 2">
                    <img src="design/{$settings->theme|escape}/images/banner2.png" alt=""  title="" /></a>
                </div>
                <div class="main_bot_banners-banner">
                  <a href="./kredit " target="_blank" title="Баннер 3">
                    <img src="design/{$settings->theme|escape}/images/banner3.png" alt=""  title="" /></a>
                </div>
                <div class="main_bot_banners-banner">
                  <a href="./aktsii" title="Баннер 4">

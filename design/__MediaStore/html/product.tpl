			...
			<div class="catalog-element-right">
				...
				<div class="catalog-element-props_and_buy_block clearfix">
					<div class="catalog-element-buy_block">
						<div class="catalog-element-buy_block_bg">
							<div class="catalog-element-buy_block_inner">
								...
								<div class="catalog-element-kredit"><a href="/credit" class="submit" rel="nofollow"><i class="icon multimage_icons"></i>Купить в кредит</a></div>
								<div class="catalog-element-dostavka"><i class="icon multimage_icons"></i>До 7-ми рабочих дней</div>
					...
					<div class="catalog-element-prevtext">
						<div class="scroll_detail_previevtext" style="overflow: hidden; padding: 0px; width: 347px;">
							<div class="jspContainer" style="width: 347px; height: 465px;">
								<div class="jspPane" style="padding: 0px; top: 0px; left: 0px; width: 347px;">
			...
			<div class="catalog-element-bottom clearfix">
				<div class="catalog-element-tabs js_tabs">
					<div class="personal-tabsheader">
						...
						{if $product->features}
							<a rel="nofollow" class="incative incative-border" href="#tab_properties">
								<span class="tabbg-center ">Характеристики</span>
								<span class="img-cart multimage_icons"></span>
							</a>
						{/if}
							<a rel="nofollow" class="incative incative-border" href="#tab_reviews">
					...
					<div class="personal-tabscontent">
						...
						{if $product->features}
							<div id="tab_properties" class="tabs-content js_tabs_content">
						...
						{/if}
						<div id="tab_reviews" class="tabs-content js_tabs_content">

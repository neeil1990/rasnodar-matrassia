			...
			//featured
				...
				if ($this.is('input[type="checkbox"]')) {
					if($this.parent(':not(.disabled)')){
						$('.popover').css({top:'-8px', left:$this.parent('li').width()});
					}
				}else{
...
function popover(z){
	return "<div id='modef' class='popover modef'><div class='bhfilter-littlepopup-lp multimage_icons'></div><div class='bhfilter-littlepopup-cp multimage_backs'><span id='modef_num'>" + 'Найдено ' +z + "</span>&nbsp;<a class='showchild littlepopup_link apply' href='#'>Показать</a></div><div class='bhfilter-littlepopup-rp multimage_icons'></div></div>";
}
